...
export class ReviewController {
  ...
  static async createReview(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const review = await ReviewController.reviewService.createReview(produtoId, usuarioId, data);
  ...
  static async updateReview(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const review = await ReviewController.reviewService.updateReview(id, usuarioId, data);
  ...
  static async getAllReviews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const reviews = await ReviewController.reviewService.getAllReviews(page, limit);

...
couponRouter.get('/codigo/:codigo', (req, res, next) =>
  couponController.findByCode(req, res, next),
);
...
// Criar cupom
couponRouter.post('/', validateSchema(createCouponSchema), (req, res) =>
  couponController.create(req, res),
);

// Atualizar cupom
couponRouter.put('/:id', validateSchema(updateCouponSchema), (req, res) =>
